...
export class Customizator {
  constructor() {
    this.btnBlock = document.createElement("div");
    this.colorPicer = document.createElement("input");
    ...
    this.colorPicer.addEventListener("input", (e) => this.onColorChange(e));
  ...
  setBgColor() {
    ...
    this.colorPicer.value = this.color;
  }
  ...
  render() {
    ...
    panel.append(this.btnBlock, this.colorPicer, this.clear);
    this.clear.innerHTML = "&times"; // подставит простой крестик
    this.clear.classList.add("clear");

    scaleInputS.classList.add("scale_btn");
    scaleInputM.classList.add("scale_btn");
    this.btnBlock.classList.add("scale");
    this.colorPicer.classList.add("color");
    ...
    this.colorPicer.setAttribute("type", "color");
    this.colorPicer.setAttribute("value", "#ffffff");
